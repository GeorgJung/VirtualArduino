...
\newcommand{\titleOfThesisOne}{Vitual Arduino}

\newcommand{\authorOfThesis}{Ebtessam Zoheir}
\newcommand{\supervisorOne}{Georg Jung}
...
\ifpdf
\pdfinfo {
	/Author (\EbtessamZoheir)
	/Title (\Bachelor)
	/Subject (\VirtualArduino)
	/Keywords ()
